...
topic_model = BERTopic.load("Jsevere/bertopic-admissions-mmr-keybert")  # or HF path
...
topic_to_response = {
    ...
    4: "For additional information about the application process (for your specific program), please check the Admissions page.",
}
